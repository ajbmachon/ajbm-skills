...
A critic agent reads ALL proposals and critiques each directly:
...
You are [PERSONA]. You've seen the Critic's assessment.
...
**Relationship to the 32-Agent Protocol:**
