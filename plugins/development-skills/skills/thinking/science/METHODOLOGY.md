...
**This document elaborates on each phase of the scientific method.**
...
| Tool | Use For |
|------|---------|
| **Research** | External knowledge, precedent, best practices |
...
| Tool | Use For |
|------|---------|
| **Council** | Multi-perspective brainstorming |
| **Red Team** | Stress-testing hypotheses |
| **Research** | Finding what's worked elsewhere |
| **be-creative** | Exploring creative approaches |
...
| **Prompts** | Evals, A/B testing |
| **UI/UX** | Worktrees, design variants |
...
## Integration with Other Thinking Modes
