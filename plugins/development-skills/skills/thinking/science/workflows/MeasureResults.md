...
Only collect data that relates to the goal. More data is not better data.
...
- Bad: Checking results early and stopping when they look good
- Good: Completing planned data collection before analysis

### Pitfall 2: Selective Reporting
- Bad: Only recording measurements that support the hypothesis
- Good: Recording all measurements, especially unexpected ones

### Pitfall 3: Lost Context
- Bad: Raw numbers without notes on conditions
- Good: Every measurement includes relevant context

### Pitfall 4: Destroyed Raw Data
- Bad: Only keeping summarized/derived metrics
- Good: Preserving original data files unmodified

### Pitfall 5: Measurement Interference
- Bad: The act of measuring changes the outcome
- Good: Using non-intrusive measurement methods
