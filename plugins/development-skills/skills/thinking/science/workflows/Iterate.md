...
- Bad: Giving up after one failed hypothesis
- Good: Systematic exploration of hypothesis space

### Pitfall 2: Refusing to Stop
- Bad: Endless iteration seeking perfection
- Good: Shipping when goal is achieved

### Pitfall 3: Not Learning from Failure
- Bad: "That didn't work, let's try something else"
- Good: "That didn't work because X, which teaches us Y"

### Pitfall 4: Ignoring Paradigm Shifts
- Bad: Staying in the same frame despite evidence it's wrong
- Good: Recognizing when fundamental reframing is needed

### Pitfall 5: No Documentation
- Bad: Moving on without recording learnings
- Good: Capturing insights for future reference
