...
**Examples:**
- Bad: "Make the app faster" (vague)
- Good: "Page load time is under 1 second for 95% of users"

- Bad: "Fix the bug" (vague)
- Good: "Users can complete checkout without encountering the 500 error"

- Bad: "Improve the content" (vague)
- Good: "Blog post generates 50+ comments and 1000+ shares"
...
- Bad: "Make it better"
- Good: "Reduce load time from 3s to under 1s"

### Pitfall 2: No Falsifiability
- Bad: "Improve user experience" (how would you fail?)
- Good: "Increase task completion rate from 60% to 80%"

### Pitfall 3: Moving Goalposts
- Bad: "Well, we didn't hit the metric, but qualitatively it feels better..."
- Good: "We didn't hit the metric. That's a failure. What did we learn?"

### Pitfall 4: Missing Constraints
- Bad: "Optimize the system" (with unlimited time and resources?)
- Good: "Optimize the system within 2 weeks using existing infrastructure"

### Pitfall 5: Scope Creep via Unstated Anti-Goals
- Bad: Project keeps expanding because boundaries weren't defined
- Good: Explicitly stated: "We are NOT redesigning the entire auth system"
