...
| [Criterion 3]     | [Value]  | [Value] | Met/Not Met |
...
Use Red Team to attack your conclusions.
...
|-----------|----------|----------|--------|
| [Crit 1]  | [Value]  | [Value]  | Met/Not Met |
...
- Bad: "We didn't hit the number, but qualitatively it's better..."
- Good: "We didn't hit the number. That's a failure. What did we learn?"

### Pitfall 2: Cherry-Picking
- Bad: Highlighting only data that supports the hypothesis
- Good: Presenting all data, including contradictory evidence

### Pitfall 3: Over-Interpreting
- Bad: Drawing sweeping conclusions from limited data
- Good: Matching confidence to evidence strength

### Pitfall 4: Dismissing Failures
- Bad: "The experiment didn't work, let's move on"
- Good: "The experiment failed — why? What does that teach us?"

### Pitfall 5: Confirmation Interpretation
- Bad: Interpreting ambiguous data as supporting your belief
- Good: Explicitly considering alternative interpretations
