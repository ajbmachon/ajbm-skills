...
**Use Council** for multi-perspective brainstorming.
...
### 4. Red Team
Use Red Team to attack your hypotheses from multiple angles.
...
- Bad: "I think it's the database"
- Good: "It could be: database, cache, API, or client-side rendering"

### Pitfall 2: Unfalsifiable Hypotheses
- Bad: "The code quality is poor"
- Good: "Specific module X has cyclomatic complexity > 20"

### Pitfall 3: Confirmation Bias
- Bad: Looking only for evidence that supports your favorite idea
- Good: Actively seeking evidence that would disprove each hypothesis

### Pitfall 4: Attachment to Initial Hypothesis
- Bad: "I'm 90% sure it's H1, so let's focus on that"
- Good: "Let's test the cheapest hypotheses first regardless of confidence"

### Pitfall 5: Missing the Null
- Bad: Assuming something is definitely wrong
- Good: Considering: "What if this is working as intended?"
