...
**Tool:** Evals methodology

For prompt experiments, use established evaluation methodology rather than reinventing it:
...
- Bad: Building elaborate test infrastructure for a simple question
- Good: Finding the minimum viable test that answers the question

### Pitfall 2: Confirmation Design
- Bad: Designing tests that can only succeed
- Good: Designing tests that could definitively fail

### Pitfall 3: Moving Targets
- Bad: Changing success criteria after seeing results
- Good: Pre-committing to criteria before running

### Pitfall 4: Ignoring Confounders
- Bad: Assuming all differences are due to the treatment
- Good: Identifying and controlling for other variables

### Pitfall 5: Insufficient Sample
- Bad: Declaring results from N=3
- Good: Understanding minimum sample for statistical validity
